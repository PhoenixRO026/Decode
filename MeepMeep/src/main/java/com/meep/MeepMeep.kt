//RedSmallTriangleStart meepmeep
...
fun main() {
    ...
    val startPose = Pose(-63.inch, -11.inch, 0.0.deg)
    ...
    val endPose = Pose(10.inch, -58.inch, -140.0.deg)

    val shootingTime = 4.2


    val meepMeep = MeepMeep(950)
    ...
    myBot.runAction(
        myBot.drive.actionBuilder(startPose.pose2d).ex()
