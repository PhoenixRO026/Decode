...
class SmallTriangleRed9 : LinearOpMode() {
    ...
    val bigTrianglePose = Pose(-16.5.inch, 16.inch, 138.0.deg) //trebe verficat?

    val rightIntakePose = Pose(36.inch, 30.inch, 90.0.deg)
    val middleIntakePose = Pose(13.inch, 29.inch, 90.0.deg) //trebe modificat
    val leftIntakePose = Pose(-11.5.inch, 28.inch, 90.0.deg)

    val endPose = Pose(0.inch, 28.inch, -90.0.deg) // trebe modificat
    ...
    override fun runOpMode() {
        ...
        val actionPGP = SequentialAction(
            ...
            robot.shootBalls(rpmFar, Spindexer.TransferPos.shoot1),
            ...
            robot.drive.actionBuilder(rightIntakePose)
                .setTangent(-90.deg)
                .afterTime(0.s, robot.intakeBalls(Spindexer.TransferPos.intake1))
