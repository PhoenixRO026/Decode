...
public final class MecanumDrive {
    public static class Params {
        ...
        public double lateralInPerTick = 0.02703868903389032;
        public double trackWidthTicks = 319.3654979259328;

        // feedforward parameters (in tick units)
        public double kS = 1.5350547754962842;
        public double kV = 0.00542798640468622;
        ...
        public double maxAngVel = 4; // shared with path
    ...
    public MecanumDrive(HardwareMap hardwareMap, Pose2d pose) {
        ...
        leftBack = hardwareMap.get(DcMotorEx.class, "motorLB");
        rightBack = hardwareMap.get(DcMotorEx.class, "motorRB");
    ...
    public final class CorrectionAction implements Action {
        ...
        public CorrectionAction(Pose target, Duration maxTime) {
            this.target = target.getPose2d();
            this.maxTimeS = maxTime.asS;
            //timeTrajectory = t;
    ...
    public final class FollowTrajectoryAction implements Action {
        ...
        public boolean run(@NonNull TelemetryPacket p) {
            ...
            if (t >= timeTrajectory.duration + correctionTimeSec) {
                leftFront.setPower(0);
                leftBack.setPower(0);
                rightBack.setPower(0);
                rightFront.setPower(0);
