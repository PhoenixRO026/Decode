...
@TeleOp
open class SoloDrive : LoggedOpMode(){
    ...
    override fun runOpMode() {
        ...
        val shootGreen = ButtonReader { gamepad1.a }
        val shootPurple = ButtonReader { gamepad1.b }
        // dpad_up = reset field centric
        val shootAll = ButtonReader { gamepad1.y }
        val highRpm = ButtonReader {gamepad1.right_bumper}
        val lowRpm = ButtonReader {gamepad1.left_bumper}
        val stopShooter = ButtonReader {gamepad1.dpad_left}
        val restShooter = ButtonReader {gamepad1.dpad_right}
        val intakeBallsSort = ToggleButtonReader ({gamepad1.x})
        val buttons = listOf(shootGreen, shootPurple, shootAll, highRpm, lowRpm, stopShooter, intakeBallsSort)
