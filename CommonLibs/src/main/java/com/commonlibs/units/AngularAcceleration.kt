...
data class AngularAcceleration(@JvmField var angularVelocity: AngularVelocity, @JvmField var duration: Duration): MeasuredUnit {
    ...
    override fun getValue() = asRadSec2
    override fun getUnit() = "radian per second squared"
}
